                            ...
                            <div className="space-y-4">
                                <div className="flex items-center space-x-4 hover-scale">
                                    <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center">
                                        <span className="text-2xl text-green-500">5499</span>
                                    </div>
                                    <p className="text-lg">Starting Rate</p>
                                </div>
                                <div className="flex items-center space-x-4 hover-scale">
                                    <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center">
                                        <span className="text-2xl text-yellow-500">2500</span>
                                    </div>
                                    <p className="text-lg">Per Kilometer Discount</p>
                                </div>
                            </div>
                            <button className="bg-white text-black px-8 py-3 rounded-full font-medium transition-all duration-300 hover:bg-opacity-90 hover:scale-105">
                                Book Now
                            </button>
                        </div>
