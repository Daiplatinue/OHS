...
function NewsAdmin() {
  ...
  const authors = {
    user1: {
      ...
      avatar: "https://cdn.pixabay.com/photo/2024/11/11/14/34/parakeets-9190236_1280.jpg",
      initials: "AJ",
      verified: true,
      followers: 12450,
    },
  ...
  const pendingPosts: Post[] = [
    {
      ...
      mediaUrl: "https://cdn.pixabay.com/photo/2024/11/11/14/34/parakeets-9190236_1280.jpg",
      mediaType: "image",
